...
public class EditCommand extends Command {
    ...
    private static Client createEditedClient(Client clientToEdit, EditClientDescriptor editClientDescriptor) {
        ...
        Set<Pet> updatedPets = editClientDescriptor.getPets().orElse(clientToEdit.getPets());

        return new Client(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedTags, updatedPets);
    }
